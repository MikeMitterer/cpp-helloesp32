...
const std::string HelloWorld_VERSION_MAJOR = "0";
const std::string HelloWorld_VERSION_MINOR = "1";

// Password compiled into source
// Set in .config/passwords.cmake (or via ENV-VAR)
const std::string HelloESP32_PASSWORD_LS = "q9uPadfh#udshf";
const std::string HelloESP32_PASSWORD_TPL = "8+uCXTsouf#auh";
